package com.tasksproject.tasklist.repository

import android.content.ContentValues
import android.content.Context
import android.database.Cursor
import com.tasksproject.tasklist.constants.DataBaseConstants
import com.tasksproject.tasklist.entities.TaskEntity
import com.tasksproject.tasklist.repository.helper.TaskDataBaseHelper
...
class TaskRepository private constructor(context: Context) {
    ...
    fun get(taskID: Int): TaskEntity? {
        ...
        try {
            ...
            val projection = arrayOf(DataBaseConstants.TASK.COLUMNS.USERID
